(define (domain abertura_sala_no_numeric)
    ...
    (:predicates ;todo: define predicates here
        (ct_separada  ?ct - caixa_termica) ;; caixa termica esta montada
    ...
    (:action esperar_temperatura_frasco_estabilizar
        :parameters (?f - frasco)
        :precondition (and 
            (frasco_estabilizando_temperatura ?f)
        )
    ...
    (:action colocar_frasco_na_caixa
        ...
        :precondition (and 
            (ct_separada ?ct)
            (not (frasco_estabilizando_temperatura ?f))
            (not (exists (?g - geladeira) (frasco_na_geladeira ?f ?g)))
            (forall (?b - bobina) 
    ...
    (:action colocar_bobina_na_caixa
        ...
        :precondition (and 
            (ct_separada ?ct)
            (not (exists (?g - geladeira) (bobina_na_geladeira ?b ?g)))
            (not (bobina_esquentando ?b))
